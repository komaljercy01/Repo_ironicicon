        ...
        protected void dlRecently_OnItemDataBound(object sender, DataListItemEventArgs e)
        {
            try
            {
                ...
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    //adding to repeater datasource only if the directory exits
                    if (Directory.Exists(Server.MapPath("~/numbers/" + imgPhoneNo.Text + "/")))
                    {
            ...
            {
                Response.Write("Exception in Repeater DataBound - Developer Info");
            }
        }
