...
namespace Exco
{
    public partial class recently : System.Web.UI.Page
    {
        ...
        bool[] _isFilePresent = new bool[200];
        ...
        protected void dlRecently_OnItemDataBound(object sender, DataListItemEventArgs e)
        {
            try
            {
                currentRepeaterIndex = e.Item.ItemIndex;
                if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
                {
                    ...
                    if (Directory.Exists(Server.MapPath("~/numbers/" + imgPhoneNo.Text + "/")) && !string.IsNullOrEmpty(Server.MapPath("~/numbers/" + imgPhoneNo.Text + "/")))
                    {
                        _isFilePresent[currentRepeaterIndex] = true;
                        HiddenField _hdnFld = (HiddenField)e.Item.FindControl("hdnFldisFolderPresent");
                        _hdnFld.Value = "true";
                    ...
                    {
                        _isFilePresent[currentRepeaterIndex] = false;
                        HiddenField _hdnFld = (HiddenField)e.Item.FindControl("hdnFldisFolderPresent");
                        _hdnFld.Value = "false";
                    }
                }
