<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Copy of recently.aspx.cs" Inherits="Exco.recentlyV1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
       <title>Recently Matched Job Search - Hospital Jobs Openings</title>
  ...
  m = s.getElementsByTagName(o)[0]; a.async = 1; a.src = g; m.parentNode.insertBefore(a, m)
    ...
    ga('send', 'pageview');
        ...
        <section class="wrapper">
            <div class="page-title title-down"><span class="title-content">Recently Matched Job Searches</span></div>
                 <div align="center" class="row-fluid">
                 
                 
                    <!-- 4 COLUMNS -->
               
                <div style="float:left;margin: 33px 2px 3px -139px;">
         <!-- <asp:DataList ID="dlLeftAd" runat="server" RepeatColumns="1" OnItemDataBound="dlLeftAd_OnItemDataBound"  RepeatDirection="Vertical">
            <ItemTemplate>
             ...
             <a href="http://http://www.brasilbe2.com/russian/" target="_blank">
           ...
           <span style="color:Gray;"><script language="Javascript">document.write(" "+geoplugin_city());</script></span> 
        <%--   </asp:PlaceHolder>--%>
            </ItemTemplate>
            </asp:DataList> -->
               ...
               <div id="main">
                ...
                <ItemTemplate>
                  <div class="gallery clearfix" >
                          ...
                          <img src='<%# DataBinder.Eval(Container.DataItem,"Value") %>' width="100" height="120" alt="" />
