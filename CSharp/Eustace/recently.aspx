...
<head runat="server">
    <title>Recently Matched Phone Numbers - Exotic Phone Search</title>
    <!-- META TAGS -->
    <meta charset="utf-8" />
                    ...
                    <div class="Result"  style=" margin:1px 2px 3px -30px; width:100%">
                        ...
                        <asp:DataList ID="dlRecently" runat="server" OnItemDataBound="dlRecently_OnItemDataBound" OnItemCommand="dlRecently_OnItemCommand" RepeatColumns="6" RepeatDirection="Horizontal">
            	            ...
            	            <%--<li><a href='<%# Eval("Photo1")%>' rel="prettyPhoto[gallery1]"><img src='<%# Eval("Photo1")%>' width="100" height="100" alt="" /></a></li>--%>
                                <asp:HiddenField ID="hdnFldisFolderPresent" runat="server"  />
                                <a href="http://www.exoticphonesearch.com/<%# String.Format("{0}",Eval("Phone1"))%>" >
                                    <ul class="gallery clearfix" >
                                        <asp:Repeater ID="rpt" runat="server">
                                            <ItemTemplate>
                                                <li><img src='<%# DataBinder.Eval(Container.DataItem,"Value") %>'   width="100" height="100" alt="" /></li>    
				                            </ItemTemplate>
                                        </asp:Repeater>
                                    </ul>
			                    </a>
