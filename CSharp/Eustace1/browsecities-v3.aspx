    ...
    ga('send', 'pageview');
        ...
        <section class="wrapper">
         ...
         <asp:Button ID="btnSearch" runat="server" Text="SEARCH" CssClass="button1 orange-button1" onclick="btnSearch_Click"  />
            ...
            <iframe border=0 frameborder=0 marginheight=0 marginwidth=0 width=148 height=1264 scrolling=no allowtransparency=true src=http://adserver.juicyads.com/adshow.php?adzone=382716></iframe>
                ...
                <div class="row-fluid">
                  ...
                  <div class="Result" style=" margin:1px 2px 3px -30px; width:860px">

               <h2><asp:Literal ID="ltrlPhone" runat="server" Text=" Recent Exotic ads and Phone Numbers"></asp:Literal></h2>
<div style="margin-left:15px;  width:85%;  color:Black; ">Check out some of the most recent Exotic ads. Click on the image or phone number of the escort below to view all of her ads and pictures, even if they were posted in other cities. If you find multiple pics of different providers, it may be the phone number belongs to an agency or the provider is using pics other Exotic's pics.</div>
               <br>
