        ...
        void DisplayCitiesDate()
        {
            try
            {
                using (DBServices obj = new DBServices())
                {
                    ...
                    titleTag.Text = Request.QueryString["cities"].ToString() + " Exotic Profiles. See All Pics, ads, and reviews from exotic in " + Request.QueryString["cities"].ToString() + " at hospitalopenings.org";
