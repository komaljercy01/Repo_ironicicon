    ...
    ga('send', 'pageview');
        ...
        <section class="wrapper">
            ...
            <div style="float:left;margin: -7px 15px 10px 21px;">
             <input type="text" id="search" runat="server" onkeypress="return isNumberKey(event)" maxlength="10" class="field searchtext" width="300px" placeholder="1234567890" />
            </div>
         ...
         <asp:Button ID="btnSearch" runat="server" Text="SEARCH" CssClass="button1 orange-button1" onclick="btnSearch_Click"  />
            ...
            <asp:DataList ID="dlLeftAd" runat="server" RepeatColumns="1" RepeatDirection="Vertical">
            <ItemTemplate>
             ...
             <a href="http://adultfriendfinder.com/p/register.cgi?#/regpage/1" target="_blank">
              <img src='<%# Eval("Photo1")%>' alt="" width="130" height="120" /><br />
           ...
           <span style="color:Gray;"> Mumbai</span> 
                ...
                <div class="row-fluid">
                  ...
                  <div class="Result" style=" margin:1px 2px 3px -30px; width:1010px">

               <h2><asp:Literal ID="ltrlPhone" runat="server" Text=" Recent Exotic ads and Phone Numbers"></asp:Literal>
              </h2>
Check out some of the most recent Exotic working. To view an Exotic history, click on the image or phone number of the escort below to view all of her ads and picstures, even if they were posted in other cities. If you find multiple pics of different providers, it may be the phone number belongs to an agency or the provider is using pics other Exotic's pics.
               <br />
              ...
              <h3 style="font-weight:bold; font-family:Arial; "> <%#Eval("PublishDate","{0:dddd, MMM dd}") %> </h3>
                ...
                <asp:DataList ID="dlRecently" runat="server" OnItemCommand="dlRecently_OnItemCommand" RepeatColumns="6" RepeatDirection="Horizontal">
                  <ItemTemplate>
                  	  ...
                  	  <asp:PlaceHolder ID="PlaceHolder1"   Visible='<%# Eval("Photo1").ToString() != "" %>' runat="server">
                       <a href="http://www.exoticphonesearch.com/<%# String.Format("{0}",Eval("Phone1"))%>">
        ...
        <footer>
            ...
            <div id="credits-block">
                <div id="credits">2015 Copyright - Exotic Phone Search</div>
                <div id="totop"></div>
            </div>
        </footer>
        <!-- JS FILES -->
